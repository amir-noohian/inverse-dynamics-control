...
with open(file_path, 'r') as file:
    for line in file:
        ...
        jt_sum_2.append(data[9])  # 2nd joint (index 1)
        jt_sum_4.append(data[11])  # 4th joint (index 3)
        gravity_2.append(data[16])
        gravity_4.append(data[18])
        dynamics_feed_fwd_2.append(data[23])
        dynamics_feed_fwd_4.append(data[25])
