...
int wam_main(int argc, char** argv, ProductManager& pm,	systems::Wam<DOF>& wam) {
	...
	systems::FirstOrderFilter<jv_type> hp1;
	hp1.setHighPass(jv_type(omega_p), jv_type(omega_p));
	...
	systems::connect(jawam.output, wam4dofDynamics.jaInputDynamics);
	systems::connect(wam4dofDynamics.dynamicsFeedFWD, wam.input);
